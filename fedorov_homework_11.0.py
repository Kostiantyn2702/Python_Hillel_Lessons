...
# "Euclid" "years": "c. 325 – c. 270 BC." наверно должно быть "c. 325 ВС – c. 270 BC."
#  И в файле data.json в конце лишняя запятая.
# Параметр функции - имя файла. Подразумевался ж путь с именем?
